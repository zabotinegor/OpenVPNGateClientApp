...
cycles to the fallback when the primary URL fails, matching the existing REST client
fallback pattern.
...
| ID | Description |
|----|-------------|
| MQ-SUB05-001 | App launches without crashes; SSE client starts with 2 candidate URLs |
